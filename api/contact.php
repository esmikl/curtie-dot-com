<?php
    ...
    function sendEmail($contactData) {
        $message = 'Hello Curtie! Someone has submitted the contact form on your website.' . "\r\n" . "\r\n" . 'Here are the details:' . "\r\n" . "\r\n";
        ...
        $to      = 'emilysmikl@gmail.com';
        $subject = 'Contact form submission from website';
        $headers = 'From: info@curtie.com' . "\r\n" .
            'Reply-To: emilysmikl@gmail.com' . "\r\n" .
